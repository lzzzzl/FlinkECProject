...
object HotPages {
  def main(args: Array[String]): Unit = {
    ...
    val inputStream = env.readTextFile("/Users/zhengzonglin/IdeaProjects/FlinkDemo/NetworkFlowAnalysis/src/main/resources/apache.log")
...
//  lazy val pageViewCountListState: ListState[PageViewCount] = getRuntimeContext.getListState(new ListStateDescriptor[PageViewCount]("pageViewCount-list", classOf[PageViewCount]))
  ...
  override def processElement(value: PageViewCount, ctx: KeyedProcessFunction[Long, PageViewCount, String]#Context, collector: Collector[String]): Unit = {
